...
2. Go to https://huggingface.co/ and look for GGUF models by "TheBloke" (https://huggingface.co/TheBloke) You can also look for GGUF models from elsewhere, but TheBloke is usually the easiest choice. Typically, the more parameters (3b, 7b, 13b etc) the higher the file size and the higher the system requirements. Anything above 13b is discouraged.
